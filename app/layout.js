...
export const metadata = {
  ...
  description: "Swap a driving test for an earlier date. SwapTest matches you with someone who wants your DVSA date. £1 to list your test, viewing matches is free, £8 only if you swap.",
  keywords: [
    "swap driving test",
  ...
  openGraph: {
    title: "Swap Driving Test Date With Someone | SwapTest UK",
    description: "Swap a DVSA driving test date with someone who wants yours. £1 to list, viewing matches is free, £8 only if you swap. Match at your centre or a nearby one.",
  ...
  twitter: {
    ...
    title: "Swap Driving Test Date With Someone | SwapTest UK",
    description: "Swap a DVSA driving test date with someone who wants yours. £1 to list, £8 only if you swap. Match at your centre or nearby.",
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "It costs £1 to register and list your test, and viewing your matches is free. If you decide to go ahead with a swap, only the person who wants an earlier date pays an £8 swap fee — the person moving to a later date pays nothing. There are no subscriptions and no hidden charges.",
          },
        },
        {
          "@type": "Question",
