...
export default function PrivacyPage() {
  ...
  var h2Style = { fontSize: "20px", fontWeight: 700, color: "#e8e6dc", marginBottom: "16px", letterSpacing: "-0.3px" };
  var h3Style = { fontSize: "16px", fontWeight: 600, color: "#c8c6bc", marginBottom: "10px", marginTop: "24px" };
  var pStyle = { fontSize: "14px", color: "#9c9a92", lineHeight: 1.75, marginBottom: "12px" };
  var liStyle = { fontSize: "14px", color: "#9c9a92", lineHeight: 1.75, marginBottom: "6px", paddingLeft: "8px" };
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#111110" }}>
      ...
      <main style={{ maxWidth: "680px", margin: "0 auto", padding: "48px 20px 80px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#73726c", marginBottom: "40px" }}>Last updated: March 2026</p>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Full name</strong> — to identify you to your swap partner</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Email address</strong> — to send you notifications about matches and for account access</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Phone number</strong> — shared only with your confirmed swap partner for coordination</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Password</strong> — encrypted and stored securely (see Security section below)</li>
          </ul>

          <p style={pStyle}>When you create a listing, we collect:</p>
          <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Test centre name</strong> — used for matching</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Current test date and time</strong> — used for matching</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Preferred date range</strong> — used for matching</li>
          </ul>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            <strong style={{ color: "#c8c6bc" }}>We do not:</strong> sell your data to third parties, use your data for advertising, share your information with anyone other than your confirmed swap partner, or use your data for any purpose other than operating the SwapTest service.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            Your personal contact details (name, email address, and phone number) are shared with another user <strong style={{ color: "#c8c6bc" }}>only after both you and the other person have agreed to swap</strong>.
        ...
        <div style={sectionStyle}>
          ...
          <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Access</strong> — request a copy of the personal data we hold about you</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Rectification</strong> — ask us to correct inaccurate data</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Erasure</strong> — ask us to delete your data</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Restriction</strong> — ask us to limit how we use your data</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Portability</strong> — request your data in a portable format</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Objection</strong> — object to our processing of your data</li>
          </ul>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Resend</strong> — for sending email notifications (processes your email address)</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Neon</strong> — for database hosting (stores your account and listing data)</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Vercel</strong> — for website hosting (processes your requests)</li>
            <li style={liStyle}><strong style={{ color: "#c8c6bc" }}>Upstash</strong> — for rate limiting (processes your IP address temporarily)</li>
          </ul>
        ...
        <div style={{
          ...
          background: "#161614", border: "1px solid #222",
        }}>
