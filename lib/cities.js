...
export const CITIES = {
  ...
  northampton: {
    slug: "northampton",
    name: "Northampton",
    region: "Northamptonshire and around",
    // Rugby and Peterborough are included deliberately even though neither can
    // actually swap with the Northampton triangle. The page explains why, and
    // leaving them out would hide the answer people arrive looking for.
    centres: [
      "Northampton",
      "Kettering",
      "Wellingborough",
  ...
  southampton: {
    slug: "southampton",
    name: "Southampton",
    region: "Hampshire and the Solent",
    // Poole and Salisbury are in the list on purpose. Both can move TO
    // Southampton but Southampton cannot move back, so no swap is possible and
    // the page says so. Hiding them would leave those learners guessing.
    centres: [
      "Southampton (Maybush)",
      "Portsmouth",
      "Lee On The Solent",
  ...
  edinburgh: {
    slug: "edinburgh",
    name: "Edinburgh",
    region: "Edinburgh, the Lothians and Fife",
    // Ordered as spokes around Currie, which is the hub the page explains.
    // Grangemouth and Haddington are included because they are how Livingston
    // and Musselburgh reach anything beyond Currie.
    centres: [
      "Edinburgh (Currie)",
  ...
  glasgow: {
    slug: "glasgow",
    name: "Glasgow",
    region: "Glasgow and Lanarkshire",
    // Ordered west to east, which is how the page explains the city. Lanark is
    // included on purpose despite having no possible partner at all: the whole
    // point of the table is to answer that question rather than leave it open.
    centres: [
      "Glasgow (Anniesland)",
      "Glasgow (Shieldhall)",
      "Bishopbriggs",
