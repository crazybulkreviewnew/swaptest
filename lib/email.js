...
export async function sendMatchFoundEmail(user, listing, matches) {
  ...
  var content = greeting(user.name)
    ...
    + para("Somebody has listed a test that works with yours. Nothing has been arranged yet, and they have not been told about you either. It only moves forward if you ask.")
    + detailsCard([
    ...
    + para("<strong>What to do next.</strong> Open your dashboard using the button below. The swap is shown at the top of the page. Press the green button on it to send them a request. They then get 24 hours to say yes or no.")
