...
export async function sendWelcomeEmail(user) {
  ...
  var content = greeting(user.name)
    ...
    + para("It costs <strong>£1</strong> to list your test. Viewing your matches is free; an <strong>£8</strong> fee applies only if you go ahead with a swap, paid by the person who wants an earlier date.")
