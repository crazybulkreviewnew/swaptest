        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5 text-[15px] leading-relaxed text-[var(--muted)]">
            ...
            <p>
              ...
              date, so every swap is designed to be fair to both sides.{pay ? " It is free if you are happy to go later, and you" : " It is currently free to list your test, and you"}
            ...
            <p>
              ...
              your data is protected at every step.{pay ? " It is free if you will take a later date and £1 a week if you want an earlier one, with no" : " SwapTest is currently free to use, with no"}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16">
            {[
              ...
              },
              {
                ...
                a: pay
                  ? "It depends which way you are going. If you are happy to move to a later date, SwapTest is completely free: listing, matching and swapping all cost nothing, because you are the reason a swap is possible at all. If you want an earlier date, a membership costs £1 a week, starts with a 7 day free trial, and can be cancelled any time from your dashboard."
